...
from products.factories import CategoryFactory, ProductVariantFactory
...
class DiscountFactory(DjangoModelFactory):
    ...
    valid_from = factory.Faker(
        "date_time_this_year", before_now=True, after_now=False, tzinfo=tz.utc
    )
...
class CouponFactory(DjangoModelFactory):
    ...
    usage_count = factory.LazyAttribute(
        lambda o: fake.random_int(min=0, max=o.usage_limit - 10)
    )
