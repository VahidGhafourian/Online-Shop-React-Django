...
class CategoryFactory(DjangoModelFactory):
    ...
    product_attributes_schema = factory.LazyFunction(
        lambda: {"color": "string", "size": "string"}
    )
    variant_attributes_schema = factory.LazyFunction(
        lambda: {"color": "string", "size": "string"}
    )
...
class ProductVariantFactory(DjangoModelFactory):
    ...
    title = factory.LazyAttribute(
        lambda obj: f"{obj.product.title} - Variant {factory.Sequence(lambda n: n)}"
    )
    slug = factory.LazyAttribute(lambda obj: slugify(obj.title))
