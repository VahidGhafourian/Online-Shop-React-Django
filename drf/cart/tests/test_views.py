...
class CartViewTest(APITestCase):
    ...
    def test_update_cart_item_quantity(self):
        cart_item = CartItemFactory(cart=self.cart, product_variant=self.product_variant, quantity=1)
    ...
    def test_remove_item_from_cart(self):
        cart_item = CartItemFactory(cart=self.cart, product_variant=self.product_variant)
        url = reverse('cart:cart-item-edit', kwargs={'item_id': cart_item.id})
